...
(function(){
  for(var i = 0; i < 256; ++i) {
    nchar_to_int[handleBug(int_to_nchar[i])] = i;
  }
})()
...
(function(){
  for(var i = 0; i < 256; ++i) {
    regexified.push("\\u00" + i.toString(16));
  }
})()
  
var characters = {};
characters.encode_char = function(c) { return nchar_to_int[c]; };
characters.decode_char = function(c) { return int_to_nchar[characters.char_to_int(c)]; };
characters.encode = function(s) { var r = ""; for(var i = 0; i < s.length; ++i) r += characters.encode_char(s[i]); return r; };
characters.decode = function(s) { var r = ""; for(var i = 0; i < s.length; ++i) r += characters.decode_char(s[i]); return r; };
characters.correctify = function(c) { return characters.encode_char(characters.correct(c)); };
characters.correctifyE = function(c) { return "\\" + characters.encode_char(characters.correct(c)); };
characters.int_to_char = function(i) { return String.fromCharCode(i); };
characters.char_to_int = function(i) { return i.charCodeAt(0); };
characters.regex = {};
characters.chars = [];
(function(){
  for(var i = 0; i < 256; ++i) {
...
characters.tiny_digits = [characters.correctify('°'),characters.correctify('¹'),characters.correctify('²'),
                          characters.correctify('³'),characters.correctify('⁴'),characters.correctify('⁵'),
                          characters.correctify('⁶'),characters.correctify('⁷'),characters.correctify('⁸'),
                          characters.correctify('⁹')];
